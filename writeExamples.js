...
Hay diferentes métodos para el modelo y para la instancia (ej. find tiene sentido aplicarlo al modelo, no a una instancia de un modelo que sería un gato solo).
